...
public class PlaywrightConfig {
    ...
    public String getBrowserType() {
        return System.getProperty("browser") != null ? System.getProperty("browser") : StringUtils.isBlank(config.getProperty("browserType")) ? "chromium" : config.getProperty("browserType");
    }

    public String getChannel() {
        return System.getProperty("channel") != null ? System.getProperty("channel") : config.getProperty("channel");
    }
